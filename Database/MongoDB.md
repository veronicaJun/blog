...
* 一个JSON 文件 好比是一个 数据库，一个 Mongodb 服务下可以有 N 个数据库
* JSON 文件中的 一级属性的数组值好比是 集合
* 数组中的对象好比是 文档
* 对象中的属性有时也称之为 字段
...
>然后可以使用 mongo命令连接本机的 mongodb 服务
>注意:
